    ...
    <footer className="bg-[#2F3E4C] text-white">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 rounded-full bg-gray-600 flex items-center justify-center hover:bg-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#programa" className="text-gray-300 hover:text-primary transition-colors">
                  Programa
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-600 pt-4 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400">
          <p>© 2024 3FIT. Todos os direitos reservados.</p>
